    ...
    await productRepo.insert([
      {
        ...
        descripcion:
          'Hamburguesa de carne de res con lechuga, tomate, cebolla y salsa especial',
        ingredientes:
          'Carne de res, pan, lechuga, tomate, cebolla, queso, salsa',
        precio: 89.0,
        foto: null,
      ...
      },
      {
        ...
        ingredientes:
          'Carne de res, pan, tocino, cebolla, queso cheddar, salsa BBQ',
        precio: 109.0,
        foto: null,
        disponibilidad: 'disponible',
      },
      ...
      },
      {
        ...
        ingredientes:
          'Lechuga romana, aderezo césar, queso parmesano, crutones',
        precio: 69.0,
        foto: null,
        disponibilidad: 'disponible',
      },
